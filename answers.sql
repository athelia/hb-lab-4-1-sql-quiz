...
SELECT SUM(order_total) AS all_melon_orders FROM orders;
...
SELECT AVG(order_total) AS avg_melon_order FROM orders;
...
SELECT MIN(order_total) AS min_melon_order FROM orders;
